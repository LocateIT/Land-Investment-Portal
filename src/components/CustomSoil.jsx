...
const CustomClimateSelect = ({ fetchSoilData }) => {
  ...
  const [optionsList, setOptionsList] = useState(dashboardSlice.soil_products)
  ...
  const handleOptionClick = (e) => {
    ...
    fetchSoilData(e.target.getAttribute("data-name"))
    // const { fetchSoilData } = props
